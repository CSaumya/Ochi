...
const Footer_2 = () => {
  return (
    <div className='w-full text-zinc-700 bg-zinc-200 py-12 px-6 md:px-12 lg:px-20 flex flex-col lg:flex-row gap-12'>

      <div className='w-full lg:w-1/3 flex flex-col justify-between gap-6'>
        <h1 className='text-zinc-800 uppercase text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight'>
          eye-opening
        </h1>
...
<path d="M52.4097 10.1387C51.2512 10.1119 50.1066 10.3947 49.0941 10.958C48.0816 11.5212 47.2379 12.3445 46.6501 13.3427V0.172852H42.293V29.4688H46.6501C46.6501 29.1721 46.6501 18.7816 46.6501 18.7816C46.6501 15.6946 47.8619 13.4352 50.8084 13.4352C54.6046 13.4352 54.6209 17.4178 54.6209 19.6962C54.6209 22.9165 54.6209 25.5189 54.6209 28.7393V29.4987H59.0271C59.0271 29.3708 59.0488 29.2728 59.0488 29.1721C59.0488 25.5108 59.0951 21.8522 59.0325 18.1909C58.9916 15.6538 58.5015 10.1387 52.4097 10.1387Z" fill="currentColor"></path>
      ...
      <div className='w-full lg:w-2/3 flex flex-col gap-12'>
        ...
        <h1 className='text-zinc-800 uppercase text-4xl md:text-6xl lg:text-7xl font-extrabold'>
          presentations
        </h1>
          ...
          <div>
            ...
            <div className='space-y-2'>
              {['Instagram','Behance','Facebook','LinkedIn'].map((item,i)=>(
                <p key={i} className='underline cursor-pointer hover:tracking-wider transition-all'>
                  {item}
                </p>
              ))}
            </div>
        ...
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pt-10 border-t border-zinc-300 text-sm text-zinc-500'>
