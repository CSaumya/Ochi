...
const Navbar = () => {
  ...
  return (
    <div className="fixed z-[999] w-full px-6 md:px-12 lg:px-20 py-4 flex justify-between items-center backdrop-blur-xl">
      
      <div className="text-black w-24 md:w-24">
        <svg
          viewBox="0 0 72 30"
        ...
        >
          ...
          <path d="M52.4097 10.1387C51.2512 10.1119 50.1066 10.3947 49.0941 10.958C48.0816 11.5212 47.2379 12.3445 46.6501 13.3427V0.172852H42.293V29.4688H46.6501V18.7816C46.6501 15.6946 47.8619 13.4352 50.8084 13.4352C54.6046 13.4352 54.6209 17.4178 54.6209 19.6962V29.4987H59.0271C59.0488 29.2728 59.0488 29.1721 59.0488 29.1721C59.0488 25.5108 59.0951 21.8522 59.0325 18.1909C58.9916 15.6538 58.5015 10.1387 52.4097 10.1387Z" fill="currentColor"/>
        </svg>
      </div>

      <div className="hidden md:flex text-gray-800 gap-6 md:gap-10 items-center">
        {["Services", "Our Work", "About Us", "Insights", "Contact us"].map((item, index) => (
            <a key={index} className={`text-[16px] font-regular ${index === 4 && "ml-36"}`}>{item}</a>
        ))}
      </div>
...
>
  ...
  ></span>
      ...
      {open && (
        <div className="absolute top-full left-0 w-full bg-white flex flex-col items-center gap-6 py-6 shadow-md md:hidden"> {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map((item,index) => (
          <a key = {index} className="text-gray-600 text-lg">
            {item}
          </a>
        )
        )}
